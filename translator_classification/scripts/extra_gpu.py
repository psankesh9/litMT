...
WANDB_PROJ = 'translator-classification-exp-lr2e7-linear'

SAVE_PATH = PROJ_PATH + '/' + EXP_NAME
OUT_PATH = PROJ_PATH + '/exp_logs_lr2e7_linear/' + EXP_NAME
...
if not os.path.exists("/trunk/kkatsy/" + EXP_NAME):
    os.makedirs("/trunk/kkatsy/" + EXP_NAME)  
    
if not os.path.exists("/trunk/kkatsy/"+ PROJ_PATH):
    os.makedirs("/trunk/kkatsy/"+ PROJ_PATH) 
    
if not os.path.exists("/trunk/kkatsy/"+ PROJ_PATH + '/' + EXP_NAME):
    os.makedirs("/trunk/kkatsy/"+ PROJ_PATH + '/' + EXP_NAME)  
...
if FINE_TUNE:
    training_args = TrainingArguments(
        output_dir="/trunk/kkatsy/"+ PROJ_PATH + '/' + EXP_NAME,
        learning_rate=lr,
